...
function loadTakeBidData(datas, page) {
    ...
    for (var i = (page - 1) * itemsPerPage; i < (page * itemsPerPage) && i < datas.length; i++) {
        if (datas[i]) {
            ...
            <td class="sellInput"><input type="password" class="form-control" id="sellInput"></td>\
            <td class="sumit"><button type="button" class="btn btn-primary waves-effect waves-light">送出</button></td>\
        </tr>';
        }
    }
    selectedPage();
